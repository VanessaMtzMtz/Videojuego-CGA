...
glm::vec3 escalamientoLich = glm::vec3(0.7f, 0.7f, 0.7f);
glm::mat4 modelMatrixLich = glm::mat4(1.0f);
glm::mat4 modelMatrixSnowman = glm::mat4(1.0f);
glm::mat4 modelMatrixSnowman2 = glm::mat4(1.0f);
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	cylinderRay2.setColor(glm::vec4(0.5, 1.0, 0.4, 1.0));
	...
	//Lich
	lichAnimate.loadModel("../models/Lich/lich.fbx");
	lichAnimate.setShader(&shaderMulLighting);

	//Snowman
	snowman.loadModel("../models/Snowman/snowman_finish.fbx");
	snowman.setShader(&shaderMulLighting);

	//Snowman2
	snowman2.loadModel("../models/Snowman/snowman_finish.fbx");
	snowman2.setShader(&shaderMulLighting);

	//Craneo
	modelSkull.loadModel("../models/Skull/Skull.fbx");
...
bool processInput(bool continueApplication) {
	...
	if (modelSelected == 3 && glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS) {
		modelMatrixLich = glm::translate(modelMatrixLich, glm::vec3(0.0f, 0.0f, 0.03f));
		lichAnimate.setAnimationIndex(0);
	}
	...
	if (modelSelected == 3 && glfwGetKey(window, GLFW_KEY_RIGHT) == GLFW_PRESS) {
		modelMatrixLich = glm::rotate(modelMatrixLich, -0.01f, glm::vec3(0.0f, 1.3f, 0.0f));
		lichAnimate.setAnimationIndex(0);
	}
...
void applicationLoop() {
	...
	modelMatrixSnowman = glm::translate(modelMatrixSnowman, glm::vec3(5.0f, 1.0f, 1.0f));

	modelMatrixSnowman2 = glm::translate(modelMatrixSnowman2, glm::vec3(15.0f, 1.2f, 1.0f));

	modelMatrixMayow = glm::translate(modelMatrixMayow, glm::vec3(13.0f, 0.05f, -5.0f));
	modelMatrixMayow = glm::rotate(modelMatrixMayow, glm::radians(-90.0f), glm::vec3(0, 1, 0));

	modelMatrixLich = glm::translate(modelMatrixLich, glm::vec3(0.0f, 0.0f, 0.0f));

	modelMatrixSkull = glm::translate(modelMatrixSkull, glm::vec3(3.0f, 0.0f, 3.0f));
	modelMatrixSkull= glm::rotate(modelMatrixSkull, glm::radians(-90.0f), glm::vec3(1, 0, 0));
	modelMatrixSkull = glm::scale(modelMatrixSkull, glm::vec3(5.0f, 5.0f, 5.0f));
	...
	while (psi) {
		...
		if (modelSelected == 1) {
			...
			axis = glm::axis(glm::quat_cast(modelMatrixLich));
			angleTarget = glm::angle(glm::quat_cast(modelMatrixLich));
			target = modelMatrixLich[3];
		}
		else {
		...
		//Snowman
		glm::mat4 modelMatrixSnowmanBody = glm::mat4(modelMatrixSnowman);
		modelMatrixSnowmanBody = glm::scale(modelMatrixSnowman, glm::vec3(1.9, 1.9, 1.9));
		modelMatrixSnowmanBody = glm::rotate(modelMatrixSnowman, glm::radians(-90.0f), glm::vec3(1.0, 0.0, 0.0));
		snowman.render(modelMatrixSnowmanBody);

		//Snowman2
		glm::mat4 modelMatrixSnowmanBody2 = glm::mat4(modelMatrixSnowman2);
		modelMatrixSnowmanBody2 = glm::scale(modelMatrixSnowman2, glm::vec3(2.9, 2.9, 2.9));
		modelMatrixSnowmanBody2 = glm::rotate(modelMatrixSnowman2, glm::radians(-90.0f), glm::vec3(1.0, 0.0, 0.0));
		snowman2.render(modelMatrixSnowmanBody2);
		...
		//LICH
		glm::vec3 ejeyLich = glm::normalize(terrain.getNormalTerrain(modelMatrixLich[3][0], modelMatrixLich[3][2]));
		glm::vec3 ejexLich = glm::normalize(modelMatrixLich[0]);
		glm::vec3 ejezLich = glm::normalize(glm::cross(ejexLich, ejeyLich));
		modelMatrixLich[0] = glm::vec4(ejexLich, 0.0f);
		modelMatrixLich[1] = glm::vec4(ejeyLich, 0.0f);
		modelMatrixLich[2] = glm::vec4(ejezLich, 0.0f);
		modelMatrixLich[3][1] = terrain.getHeightTerrain(modelMatrixLich[3][0], modelMatrixLich[3][2]);
		glm::mat4 modelMatrixLichBody = glm::mat4(modelMatrixLich);
		modelMatrixLichBody = glm::scale(modelMatrixLichBody, glm::vec3(0.01f, 0.01f, 0.01f));
		modelMatrixLichBody = glm::rotate(modelMatrixLichBody, glm::radians(-90.0f), glm::vec3(0.0, 1.0, 0.0));
		lichAnimate.render(modelMatrixLichBody);
		lichAnimate.setAnimationIndex(1);

		//Craneo
		modelMatrixSkull[3][1] = terrain.getHeightTerrain(modelMatrixSkull[3][0], modelMatrixSkull[3][2]);
		...
		/*******************************************
		 * Ray in Lich view direction
		 *******************************************////////////////////////////////////////
		glm::mat4 modelMatrixRay2 = glm::mat4(modelMatrixLich);
		modelMatrixRay2 = glm::translate(modelMatrixRay2, glm::vec3(0, 1, 0));
		glm::vec3 rayDirection2 = glm::normalize(glm::vec3(modelMatrixRay2[2]));
		glm::vec3 ori2 = glm::vec3(modelMatrixRay2[3]);
		glm::vec3 tar2 = ori2 + r2 * rayDirection2;
		glm::vec3 dmd2 = ori2 + r1 * rayDirection2;
		modelMatrixRay2[3] = glm::vec4(dmd2, 1.0);
		glm::mat4 modelMatrixRayBala = glm::mat4(modelMatrixRay);
		modelMatrixRay2 = glm::rotate(modelMatrixRay2, glm::radians(90.0f), glm::vec3(1.0, 0.0, 0.0));
		modelMatrixRay2 = glm::rotate(modelMatrixRay2, glm::radians(90.0f), glm::vec3(0.0, 1.0, 0.0));
		modelMatrixRay2 = glm::scale(modelMatrixRay2, glm::vec3(1.0, 8.0, 1.0));
		...
		glm::mat4 modelMatrixCollidersnowman = glm::mat4(modelMatrixSnowman);
		modelMatrixCollidersnowman[3][1] = terrain.getHeightTerrain(modelMatrixCollidersnowman[3][0], modelMatrixCollidersnowman[3][2]);
		snowmanCollider.u = glm::quat_cast(modelMatrixSnowman);
		modelMatrixCollidersnowman = glm::scale(modelMatrixCollidersnowman, glm::vec3(1.0, 5.5, 1.0));
		modelMatrixCollidersnowman = glm::translate(modelMatrixCollidersnowman, snowman.getObb().c);
		snowmanCollider.c = glm::vec3(modelMatrixCollidersnowman[3]);
		snowmanCollider.e = snowman.getObb().e * glm::vec3(1.0, 5.5, 1.0);
		addOrUpdateColliders(collidersOBB, "snowman", snowmanCollider, modelMatrixSnowman);
		...
		//Collider Lich////////////////////////////////
		AbstractModel::OBB LichCollider;
		glm::mat4 modelMatrixColliderLich = glm::mat4(modelMatrixLich);
		modelMatrixColliderLich[3][1] = terrain.getHeightTerrain(modelMatrixColliderLich[3][0], modelMatrixColliderLich[3][2]);
		modelMatrixColliderLich = glm::rotate(modelMatrixColliderLich, glm::radians(180.0f), glm::vec3(1.0, 0.0, 0.0));
		LichCollider.u = glm::quat_cast(modelMatrixColliderLich);
		modelMatrixColliderLich = glm::scale(modelMatrixColliderLich, escalamientoLich);
		modelMatrixColliderLich = glm::translate(modelMatrixColliderLich, lichAnimate.getObb().c);
		LichCollider.e = lichAnimate.getObb().e * escalamientoLich;// *glm::vec3(1.0, 1.0, 1.0);
		LichCollider.c = modelMatrixColliderLich[3];
		addOrUpdateColliders(collidersOBB, "Lich", LichCollider, modelMatrixLich);
		...
		//Collider snowman2/////////////////////////////////////////////////////////////////////////////////////////////////
		AbstractModel::SBB snowman2Collider;
		glm::mat4 modelMatrixCollidersnowman2 = glm::mat4(modelMatrixSnowman2);
		modelMatrixCollidersnowman2[3][1] = terrain.getHeightTerrain(modelMatrixCollidersnowman2[3][0], modelMatrixCollidersnowman2[3][2]);
		modelMatrixCollidersnowman2 = glm::scale(modelMatrixCollidersnowman2, glm::vec3(1.0f, 1.0f, 1.0f));
		modelMatrixCollidersnowman2 = glm::translate(modelMatrixCollidersnowman2, snowman2.getSbb().c);
		snowman2Collider.c = modelMatrixCollidersnowman2[3];
		snowman2Collider.ratio = snowman2.getSbb().ratio * 2.0f;
		addOrUpdateColliders(collidersSBB, "snowman2", snowman2Collider, modelMatrixSnowman2);

		// Bala
		AbstractModel::OBB balaCollider;
		glm::mat4 modelMatrixColliderBala = glm::mat4(modelMatrixRay);
		modelMatrixColliderBala = glm::rotate(modelMatrixColliderBala, glm::radians(90.0f), glm::vec3(1.0, 0.0, 0.0));
		balaCollider.u = glm::quat_cast(modelMatrixColliderBala);
		modelMatrixColliderBala = glm::scale(modelMatrixColliderBala, glm::vec3(1.5, 2.0, 1.5));
		modelMatrixColliderBala = glm::translate(modelMatrixColliderBala, cylinderRay.getObb().c);
		balaCollider.e = cylinderRay.getObb().e * glm::vec3(1.5, 2.0, 1.5);
		balaCollider.c = glm::vec3(modelMatrixColliderBala[3]);
		addOrUpdateColliders(collidersOBB, "bala", balaCollider, modelMatrixRayBala);
		...
		for (colIte = collisionDetection.begin(); colIte != collisionDetection.end(); colIte++) {
			...
			if (jt != collidersOBB.end()) {
				if (!colIte->second)
					...
					if (jt->first.compare("Lich") == 0)
						modelMatrixLich = std::get<1>(jt->second);
				}
			}
		}
		...
		for (std::map < std::string, std::tuple < AbstractModel::SBB, glm::mat4, glm::mat4> >::iterator it = collidersSBB.begin(); it != collidersSBB.end(); it++) {
			...
			if (raySphereIntersect(ori2, tar2, rayDirection2, std::get<0>(it->second), tray)) {
				std::cout << "Collision " << it->first << " with" << "Ray 2" << std::endl;
			}
		}
		for (std::map < std::string, std::tuple < AbstractModel::OBB, glm::mat4, glm::mat4> >::iterator it = collidersOBB.begin(); it != collidersOBB.end(); it++) {
