...
std::vector<glm::vec3> lamp2Position = { glm::vec3(-36.52, 0, -23.24),
		glm::vec3(-52.73, 0, -3.90), glm::vec3(-39.3, 0, -36.8),
		glm::vec3(-40.3, 0, -49.9), glm::vec3(-52, 0, -45.6) };
std::vector<float> lamp2Orientation = {21.37 + 90, -65.0 + 90, 0.0,-90.0, 0.0};

std::vector<glm::vec3> lamp3Position = { glm::vec3(48.9, 0, -23.9) };
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	modelLamp3.loadModel("../models/lampara/Asta LG1.obj");
...
void applicationLoop() {
	...
	while (psi) {
		...
		glm::vec3 spotPosition1 = modelMatrixLambo * glm::vec4(1.0f, 1.7f, 5.0f, 1.0f);
		...
		shaderMulLighting.setVectorFloat3("spotLights[1].position", glm::value_ptr(glm::vec3(spotPosition1)));
		shaderMulLighting.setVectorFloat3("spotLights[1].direction", glm::value_ptr(glm::vec3(0.0, -0.708, 1.0)));
		...
		shaderMulLighting.setFloat("spotLights[1].outerCutOff", cos(glm::radians(70.5f)));
		...
		shaderTerrain.setVectorFloat3("spotLights[1].position", glm::value_ptr(glm::vec3(spotPosition1)));
		shaderTerrain.setVectorFloat3("spotLights[1].direction", glm::value_ptr(glm::vec3(0.0, -0.708, 0.0)));
		...
		shaderTerrain.setFloat("spotLights[1].outerCutOff", cos(glm::radians(70.5f)));

		//Lambo 2
		glm::vec3 spotPosition2 = modelMatrixLambo * glm::vec4(-1.0f, 1.7f, 5.0f, 1.0f);
		...
		shaderMulLighting.setVectorFloat3("spotLights[2].position", glm::value_ptr(glm::vec3(spotPosition2)));
		shaderMulLighting.setVectorFloat3("spotLights[2].direction", glm::value_ptr(glm::vec3(0.0, -0.708, 0.0)));
		...
		shaderMulLighting.setFloat("spotLights[2].outerCutOff", cos(glm::radians(70.5f)));
		...
		shaderTerrain.setVectorFloat3("spotLights[2].position", glm::value_ptr(glm::vec3(spotPosition2)));
		shaderTerrain.setVectorFloat3("spotLights[2].direction", glm::value_ptr(glm::vec3(0.0, -0.708, 0.0)));
		...
		shaderTerrain.setFloat("spotLights[2].outerCutOff", cos(glm::radians(70.5f))); 
