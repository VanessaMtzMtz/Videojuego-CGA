...
Model lichAnimate;
//Mounstro
Model MounstroAnimate;

// Terrain model instance
Terrain terrain(-1, -1, 200, 20, "../Textures/mapaalt.png");
...
std::string fileNames[6] = { "../Textures/interstellar/interstellar_ft.tga",
		"../Textures/interstellar/interstellar_bk.tga",
		"../Textures/interstellar/interstellar_up.tga",
		"../Textures/interstellar/interstellar_dn.tga",
		"../Textures/interstellar/interstellar_rt.tga",
		"../Textures/interstellar/interstellar_lf.tga" };
...
glm::mat4 modelMatrixMounstro= glm::mat4(1.0f);
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	//Mounstro
	MounstroAnimate.loadModel("../models/Zombie Stand Up/Zombie Stand Up.dae");
	MounstroAnimate.setShader(&shaderMulLighting);
	...
	// Definiendo la textura a utilizar
	Texture textureTerrainR("../Textures/mud2.jpg");//////////////////////////////////////////////////////////
	// Carga el mapa de bits (FIBITMAP es el tipo de dato de la libreria)
	...
	// Definiendo la textura a utilizar
	Texture textureTerrainB("../Textures/path2.jpg"); //////////////////////////////////////////////////////////////
	// Carga el mapa de bits (FIBITMAP es el tipo de dato de la libreria)
	...
	// Definiendo la textura a utilizar
	Texture textureTerrainBlendMap("../Textures/mapablack.png");////////////////////////////////////////////
	// Carga el mapa de bits (FIBITMAP es el tipo de dato de la libreria)
...
bool processInput(bool continueApplication) {
	...
	if (modelSelected == 3 && glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS) {
		modelMatrixLich = glm::translate(modelMatrixLich, glm::vec3(0.03f, 0.0f, 0.0f));
...
void applicationLoop() {
	...
	modelMatrixMounstro = glm::translate(modelMatrixMounstro, glm::vec3(1.0f, 0.0f, 5.0f));
	...
	while (psi) {
		...
		//Se activa textura de la tierra
		glActiveTexture(GL_TEXTURE1);
		glBindTexture(GL_TEXTURE_2D, textureTerrainRID);
		shaderTerrain.setInt("rTexture", 1);
		//Se activa textura de hierba
		...
		modelMatrixMounstro[3][1] = terrain.getHeightTerrain(modelMatrixMounstro[3][0], modelMatrixMounstro[3][2]);
		glm::mat4 modelMatrixMounstroBody = glm::mat4(modelMatrixMounstro);
		modelMatrixMounstroBody = glm::scale(modelMatrixMounstroBody, glm::vec3(0.01f, 0.01f, 0.01f));
		MounstroAnimate.render(modelMatrixMounstroBody);
...
int main(int argc, char **argv) {
	init(800, 700, "Practica 4 Acosta Hernandez - Martinez Martinez", false);
	applicationLoop();
	destroy();
	return 1;
}
